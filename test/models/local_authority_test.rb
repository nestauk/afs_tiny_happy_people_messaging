...
class LocalAuthorityTest < ActiveSupport::TestCase
  ...
  test "count_users_by_created_at" do
    create(:user, local_authority: @subject, created_at: Time.new(2021, 1, 1))
    create(:user, local_authority: @subject, created_at: Time.new(2021, 2, 21))
    create(:user, local_authority: @subject, created_at: Time.new(2021, 5, 24))
  ...
  test "percentage_messages_clicked_by_created_at" do
    ...
    create(:message, user:, created_at: Time.new(2021, 1, 1), clicked_at: Time.new(2021, 1, 2), content:)
    create(:message, user:, created_at: Time.new(2021, 1, 10), content:)
    create(:message, user:, created_at: Time.new(2021, 1, 15)) # Should not be counted as doesn't have content
    create(:message, user:, created_at: Time.new(2021, 2, 1), clicked_at: Time.new(2021, 1, 2), content:)
  ...
  test "count_messages_by_created_at" do
    user = create(:user, local_authority: @subject)
    content = create(:content)
    create(:message, user:, created_at: Time.new(2021, 1, 1), content:)
    create(:message, user:, created_at: Time.new(2021, 1, 10), content:)
    create(:message, user:, created_at: Time.new(2021, 1, 15)) # Should not be counted as doesn't have content
    create(:message, user:, created_at: Time.new(2021, 2, 1), content:)
