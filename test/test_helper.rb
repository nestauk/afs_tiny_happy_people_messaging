...
module ActiveSupport
  class TestCase
    ...
    def create_all_auto_responses
      ...
      create(:auto_response, trigger_phrase: "1", response: "Thanks, we've adjusted the content you'll receive. We'll check back in in a few weeks to make sure it's right.", user_conditions: "{\"contactable\": true}", update_content_adjustment: "{\"needs_adjustment\": false, \"adjusted_at\": \"now\", \"direction\": null, \"number_options\": null}", content_adjustment_conditions: "{\"needs_adjustment\": true, \"direction\": \"not_nil\"}")
