...
class SchedulerTest < ActiveSupport::TestCase
  ...
  test "no afternoon job enqueued if user is not contactable" do
    create(:user, contactable: false, hour_preference: "afternoon", day_preference: 1)
  ...
  test "no afternoon job enqueued if user's day_preference doesn't match today" do
    create(:user, contactable: true, hour_preference: "afternoon", day_preference: 2)
